...
import { Terminal, Mail, Lock, Eye, EyeOff, User, ArrowRight } from "lucide-react";
...
export default function SignupPage() {
  ...
  if (success) {
    return (
      ...
      >
        <div
          className="w-full max-w-[400px] rounded-2xl border p-8 text-center"
    ...
    >
      ...
      >
        ...
        <p className="text-sm mb-7" style={{ color: "var(--text-secondary)" }}>
          Join StackNote and save your progress.
        </p>
